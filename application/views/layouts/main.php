        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <?php if($this->session->userdata('logged_in')): ?>
                    <li><a href="<?php echo base_url(); ?>projects"> <i class="fa fa-user" aria-hidden="true"></i></a></li>
                    <li><a href="<?php echo base_url(); ?>projects"> <i class="fa fa-cab" aria-hidden="true"></i></a></li>
                    <li><a href="<?php echo base_url(); ?>projects"> <i class="fa fa-road" aria-hidden="true"></i></a></li>
                <?php endif; ?>
